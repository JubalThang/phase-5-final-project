        ...
        <>
            ...
            <div className="w-2/3 m-auto">
                ...
                <form onSubmit={handldeOnClick}>
                    <input type="email" autoComplete="email" className=" block border focus:border-cyan-500 w-1/2 m-auto py-2 px-4  mt-8" placeholder="email address" />
                    <input type="password" className=" block border focus:border-cyan-500 w-1/2 m-auto p-2 mt-8" placeholder="password" />
